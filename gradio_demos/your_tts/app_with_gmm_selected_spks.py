...
# model_path = "/data/best_models/variant17.2/checkpoint_2740000.pth"
# config_path = "/data/best_models/variant17.2/model_config.json"

# model_path = "/raid/models/ecyourtts_v20/checkpoint_3390000.pth"
# config_path = "/raid/models/ecyourtts_v20/model_config.json"
...
SPEAKERS = [spk for spk in SPEAKERS if (spk in selected_spks and "LTTS" in spk) or "LTTS" not in spk]
...
iface = gr.Interface(
    ...
    outputs=[
        ...
        gr.Plot(label="GT pitch"),
        gr.Plot(label="Predicted pitch"),
        gr.Plot(label="Pitch Avg GT")
    ],

...
speakers_file = ["/data/TTS/gradio_demos/your_tts/embeddings/speakers_studio.pth"]
...
torch.save(emotion_embeddings, "/data/TTS/gradio_demos/your_tts/emotion_vecs_vector_algebra.pth")

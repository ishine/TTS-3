...
from TTS.tts.models.styleforward_tts import StyleForwardTTSArgs
...
class StylefastPitchConfig(BaseTTSConfig):
    ...
    model: str = "stylefast_pitch"
    base_model: str = "styleforward_tts"

    # style encoder params
    style_encoder_config: StyleEncoderConfig = None
    ...
    binary_align_loss_start_epoch: int = 1
